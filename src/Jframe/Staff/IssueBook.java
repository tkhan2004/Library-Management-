...
public class IssueBook extends javax.swing.JFrame {
        ...
        try{
            ...
            ResultSet rs = pst.executeQuery();
             ...
             lbl_quantity.setText(rs.getString("quantity"));
                 ...
                 lbl_bookError.setText("Lỗi id sách");
             }   
        ...
        try{
            ...
            ResultSet rs = pst.executeQuery();
             ...
             lbl_branch.setText(rs.getString("branch"));
                 ...
                 lbl_studentError.setText("Lỗi id sinh viên");
             }  
    ...
    public void updateBookCount(){
         ...
         try{
            ...
            if (rowCount > 0){
                ...
                JOptionPane.showMessageDialog(this, "Không thể cập nhật số lượng sách");
            }  
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(192, 2, 8));
        ...
        lbl_quantity.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_quantity.setForeground(new java.awt.Color(255, 255, 255));
        lbl_quantity.setToolTipText("");
        lbl_quantity.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        ...
        lbl_author.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lbl_author.setForeground(new java.awt.Color(255, 255, 255));
        lbl_author.setToolTipText("");
        lbl_author.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        ...
        lbl_bookName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        ...
        lbl_bookId.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        ...
        jLabel12.setText("Chi tiết sinh viên");
        jPanel4.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, -1, -1));
        ...
        lbl_branch.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        jPanel4.add(lbl_branch, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 470, 190, 40));
        ...
        lbl_course.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        jPanel4.add(lbl_course, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 390, 190, 40));
        ...
        lbl_studentName.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        jPanel4.add(lbl_studentName, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 310, 190, 40));
        ...
        lbl_studentId.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 0, 10, new java.awt.Color(255, 255, 255)));
        jPanel4.add(lbl_studentId, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 230, 190, 40));
        ...
        panel_main.add(jPanel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(1020, 200, -1, -1));
        ...
        txt_studentId.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 10, new java.awt.Color(0, 102, 204)));
        ...
        txt_bookId.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 1, 1, 10, new java.awt.Color(0, 102, 204)));
        ...
        date_dueDate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        date_issueDate.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        ...
        jLabel20.setText("Ngày Mượn sách:");
    ...
    private void rSMaterialButtonCircle4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSMaterialButtonCircle4ActionPerformed
        if(lbl_quantity.getText().equals("0")){
            JOptionPane.showMessageDialog(this, "Không có sách này!");
        }else{    
            if(isAlreadyIssued() == false){
                if (issueBook() == true){
                   JOptionPane.showMessageDialog(this, "Đã mượn sách thành công!");
                   updateBookCount();
                }else{
                ...
                JOptionPane.showMessageDialog(this, "Sinh viên này đã có sách mượn!");
            }
        } 
