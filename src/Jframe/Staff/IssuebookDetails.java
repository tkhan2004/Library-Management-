...
public class IssuebookDetails extends javax.swing.JFrame {
    ...
    public void setIssueBookDetailsToTable() {
        try {
            ...
            ResultSet rs = st.executeQuery("select * from issue_book_details where status = '"+"Đang mượn"+"'");
    ...
    private void initComponents() {
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 0, 50, 50));
